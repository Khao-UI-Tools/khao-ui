import type SocialButtons from "./components/widgets/socialButtons/SocialButtons.svelte";
...
export * as NoticeCard from "./components/cards/noticeCard/NoticeCard.svelte";
